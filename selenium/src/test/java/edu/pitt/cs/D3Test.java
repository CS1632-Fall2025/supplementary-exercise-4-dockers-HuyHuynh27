...
public class D3Test {
  ...
  public void tEST4LISTING() {
    ...
    // 3 | click | linkText=Catalog | 
    driver.findElement(By.linkText("Catalog")).click();
    // 4 | storeXpathCount | xpath=//div[@id='listing']/ul/li | listsize
    vars.put("listsize", driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li")).size());
    // 5 | assert | listsize | 3
  ...
  public void tEST6RENT() {
    ...
    // 7 | assertText | id=cat-id1 | Rented out
    assertThat(driver.findElement(By.id("cat-id1")).getText(), is("Rented out"));
    // 8 | assertText | id=cat-id2 | ID 2. Old Deuteronomy
    assertThat(driver.findElement(By.id("cat-id2")).getText(), is("ID 2. Old Deuteronomy"));
    // 9 | assertText | id=cat-id3 | ID 3. Mistoffelees
    assertThat(driver.findElement(By.id("cat-id3")).getText(), is("ID 3. Mistoffelees"));
  ...
  public void tEST7RETURN() {
    ...
    // 7 | assertText | id=cat-id1 | ID 1. Jennyanydots
    assertThat(driver.findElement(By.id("cat-id1")).getText(), is("ID 1. Jennyanydots"));
    // 8 | assertText | id=cat-id2 | ID 2. Old Deuteronomy
    assertThat(driver.findElement(By.id("cat-id2")).getText(), is("ID 2. Old Deuteronomy"));
    // 9 | assertText | id=cat-id3 | ID 3. Mistoffelees
  ...
  public void tEST8FEEDACAT() {
    ...
    // 4 | assertElementPresent | xpath=//button[@onclick='setTimeout(feedSubmit, 1000)'] | 
    {
  ...
  public void tEST10GREETACAT() {
    ...
    // 4 | click | xpath=//div[@id='greeting']/h4 | Meow!Meow!Meow!
